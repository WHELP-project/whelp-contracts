        ...
        match &offer_asset.info {
            ...
            AssetInfo::Cw20Token(contract_addr) => Ok(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                msg: to_json_binary(&Cw20ExecuteMsg::Send {
                    ...
                    msg: to_json_binary(&dex::pool::Cw20HookMsg::Swap {
                        ask_asset_info: Some(ask_asset_info),
                        belief_price,
                        max_spread,
                        to: receiver,
...
#[cfg_attr(not(feature = "library"), entry_point)]
pub fn query(deps: Deps<CoreumQueries>, _env: Env, msg: QueryMsg) -> Result<Binary, ContractError> {
    match msg {
...
mod query {
    use dex::pool::ReverseSimulationResponse;

    use super::*;

    /// Returns general contract settings in a [`ConfigResponse`] object.
    pub fn config(deps: Deps<CoreumQueries>) -> Result<ConfigResponse, ContractError> {
        let state = CONFIG.load(deps.storage)?;
        let resp = ConfigResponse {
            dex_factory: state.dex_factory.into_string(),
        };
...
mod testing {
    ...
    fn test_invalid_operations() {
        ...
        assert!(assert_operations(
            ...
            &[
                SwapOperation::DexSwap {
                    offer_asset_info: AssetInfo::SmartToken("ukrw".to_string()),
                    ask_asset_info: AssetInfo::Cw20Token("asset0001".to_string()),
                },
                SwapOperation::DexSwap {
                    offer_asset_info: AssetInfo::Cw20Token("asset0001".to_string()),
        ...
        assert!(assert_operations(
            ...
            &[
                ...
                SwapOperation::DexSwap {
                    ...
                    ask_asset_info: AssetInfo::Cw20Token("asset0002".to_string()),
                },
            ],
        )
        .is_ok());
        ...
        assert!(assert_operations(
            ...
            &[
                ...
                SwapOperation::DexSwap {
                    offer_asset_info: AssetInfo::Cw20Token("asset0001".to_string()),
                    ask_asset_info: AssetInfo::SmartToken("uaud".to_string()),
                },
                SwapOperation::DexSwap {
                    offer_asset_info: AssetInfo::SmartToken("uluna".to_string()),
                    ask_asset_info: AssetInfo::Cw20Token("asset0002".to_string()),
