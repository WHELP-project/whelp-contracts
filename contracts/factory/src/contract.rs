...
use dex::{
    ...
    factory::{
        ...
        PairConfig, PairType, PairsResponse, PartialDefaultStakeConfig, PartialStakeConfig,
        QueryMsg, ReceiveMsg, ROUTE,
    },
    fee_config::FeeConfig,
    pair::{ExecuteMsg as PairExecuteMsg, InstantiateMsg as PairInstantiateMsg, PairInfo},
...
///
/// * **QueryMsg::Pair { asset_infos }** Returns a [`PoolInfo`] object with information about a specific Dex pair.
///
